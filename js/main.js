...
function draw2() {
    ...
    if (canvas.getContext) {
        ...
        ctx.fillStyle = "rgb(255, 0, 0)"; // Rojo
        ctx.fillRect(25, 25, 100, 100);
        ctx.clearRect(45, 45, 60, 60);
        ctx.strokeStyle = "rgb(0, 0, 255)"; // Azul
...
function draw4() {
    ...
    if (canvas.getContext) {
        ...
        ctx.strokeStyle = "rgb(255, 115, 0)"; // Naranja
        ctx.beginPath();
...
function draw5() {
    ...
    if (canvas.getContext) {
        ...
        ctx.fillStyle = "rgb(128, 0, 128)"; // Púrpura
        ctx.beginPath();
        ctx.moveTo(25, 25);
        ctx.lineTo(105, 25);
        ctx.lineTo(25, 105);
        ...
        ctx.strokeStyle = "rgb(20, 138, 255)"; // Amarillo
        ctx.beginPath();
        ctx.moveTo(125, 125);
        ctx.lineTo(125, 45);
        ctx.lineTo(45, 125);
    ...
    if (canvas.getContext) {
        ...
        for (let i = 0; i < 4; i++) {
            for (let j = 0; j < 3; j++) {
                ...
                if (i > 1) {
                    ctx.fillStyle = "rgb(0, 195, 255)"; // Cian
                    ctx.fill();
                } else {
                    ctx.strokeStyle = "rgb(255, 8, 222)"; // Rosa
                    ctx.stroke();
                }
            }
        }
...
function draw7() {
    ...
    if (canvas.getContext) {
        ...
        ctx.strokeStyle = "rgb(123, 0, 255)"; // Rojo anaranjado
        ctx.beginPath();
        ctx.moveTo(75, 25);
...
function draw8() {
    ...
    if (canvas.getContext) {
        ...
        ctx.fillStyle = "rgb(235, 19, 19)"; // Índigo
        ctx.beginPath();
        ctx.moveTo(75, 40);
...
function draw9() {
    ...
    if (canvas.getContext) {
        ...
        ctx.beginPath();
        ctx.fillStyle = "rgb(243, 205, 51)";
        ctx.arc(37, 37, 13, Math.PI / 7, -Math.PI / 7, false);
        ctx.lineTo(31, 37);
        ctx.fill();

        ctx.fillStyle = "rgb(42, 74, 253)";
        for (let i = 0; i < 8; i++) {
...
function draw10() {
    ...
    if (canvas.getContext) {
        ...
        ctx.strokeStyle = "rgb(41, 255, 13)"; // Verde oscuro
        const rectangle = new Path2D();
        rectangle.rect(10, 10, 50, 50);
        ctx.stroke(rectangle);

        ctx.fillStyle = "rgb(255, 20, 147)"; // Rosa profundo
